    ...
    if (!$save_details_only) {
        if (!$is_legacy_system && $chain_id) {
            ...
            if (mysqli_num_rows($check_ratio_result) == 0) {
                ...
                $insert_ratio_query = "INSERT INTO impact_chain_ratios (impact_chain_id, outcome_id, deadweight, attribution, displacement, drop_off, created_by) VALUES (?, ?, 0.00, 0.00, 0.00, 0.00, ?)";
