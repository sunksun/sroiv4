...
<div class="section">
    ...
    <div class="metric-cards">
        <div class="metric-card">
            <div class="metric-value <?php echo $npv >= 0 ? 'highlight-positive' : 'highlight-negative'; ?>"><?php echo formatCurrency($npv, 0); ?></div>
            <div class="metric-label">NPV (บาท)</div>
        </div>
        <div class="metric-card">
            <div class="metric-value"><?php echo formatNumber($sroi_ratio, 4); ?></div>
    ...
    <div class="impact-breakdown">
        <div class="impact-item">
            ...
            <div class="impact-value"><?php echo formatCurrency($total_present_benefits, 0); ?> บาท</div>
        </div>
        <div class="impact-item">
            <h4>ผลกระทบกรณีฐาน</h4>
            <div class="impact-value"><?php echo formatCurrency($base_case_impact, 0); ?> บาท</div>
        </div>
        <div class="impact-item">
            <h4>ผลประโยชน์สุทธิหลังหักลบกรณีฐาน</h4>
            <div class="impact-value"><?php echo formatCurrency($net_social_benefit, 0); ?> บาท</div>
        </div>
        <div class="impact-item">
            <h4>ต้นทุนโครงการรวม</h4>
            <div class="impact-value"><?php echo formatCurrency($total_present_costs, 0); ?> บาท</div>
        </div>
    </div>
